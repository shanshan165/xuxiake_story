...
document.getElementById('more-trigger-btn').style.display = 'none';
...
introBtn.addEventListener('click', function() {
    ...
    document.getElementById('more-trigger-btn').style.display = 'block';
...
// ---------- 右侧“了解更多”抽屉 ----------
var moreTrigger = document.getElementById('more-trigger-btn');
var morePanel = document.getElementById('more-panel');
var moreClose = document.getElementById('more-close-btn');
...
// 面板打开时，如果用户点击地图其他位置，也可以关闭（可选）
// 这里我们只通过遮罩和关闭按钮来关闭，避免干扰地图操作